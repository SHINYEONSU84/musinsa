...
public class WebController {
    ...
    /**
     * API 1: 카테고리별 최저가격 브랜드와 상품가격, 총액을 조회하는 페이지를 제공하는 메서드
     *
    ...
    /**
     * API 2: 단일 브랜드로 모든 카테고리 상품을 구매할 때 최저가격 브랜드 조회 페이지를 제공하는 메서드
     *
    ...
    /**
     * API 3: 카테고리 이름으로 최저, 최고 가격 브랜드와 상품 가격을 조회하는 폼 페이지를 제공하는 메서드
     *
    ...
    /**
     * API 3: 선택한 카테고리의 최저, 최고 가격 브랜드와 상품 가격 결과를 제공하는 메서드
     *
